...
module.exports = {
  ...
  async create(ctx) {
    ...
    // CHECK IF DAY IS INSERTED
    if(sanitizedBody['Giorno'] == undefined) ctx.forbidden("Inserisci il giorno amico")

    // ADDING USER AUTOMATICALLY
    if(model == "api::aula.aula") {
      // get user id
      let userId = user.id
      // set entry owner
      sanitizedBody['admin_user'] = userId 
    }
